...
export const usePayrollStore = create<PayrollState>()(
  persist(
    ...
    {
      name: 'payroll-storage', // nom unique pour le localStorage
      storage: createJSONStorage(() => localStorage), // ou sessionStorage pour une persistance par session
      // Optionnel: vous pouvez sélectionner quels champs persister
      // partialize: (state) => ({ 
